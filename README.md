...
Clone the repository: git clone https://github.com/YOUR_USERNAME/InterviewPro-AI-Agent.git cd InterviewPro-AI-Agent
...
Start the Interview: Open 'index.html' in your browser.
